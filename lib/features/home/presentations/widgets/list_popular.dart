...
import 'package:netxlif/features/movie/presentations/provider/popular_provider.dart';
import 'package:netxlif/shared_widgets/shimmer_movie_small.dart';

import '../../../../core/theme.dart';
import '../../../../shared_widgets/card_movie_small.dart';

class ListPopular extends ConsumerWidget {
          ...
          SizedBox(
            ...
            child: popularMovies.when(
              ...
              error: (error, stackTrace) {
                return Center(
                  child: Text(
                    'Failed to load popular movies: $error',
